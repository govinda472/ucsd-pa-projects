...
public abstract class RPSAbstract implements RPSInterface {
    ...
    public boolean isValidMove(String move) {
        // TODO
        // Use a loop here - done

        for(int i=0; i<this.possibleMoves.length; i++) {
                if (this.possibleMoves[i].equals(move)){
                        return true;
                } 
                }
    ...
    public void playRPS(String playerMove, String cpuMove) {
        ...
        // Use determineWinner to determine who won- done
        ...
        // Add one to the appropriate statistics - done
